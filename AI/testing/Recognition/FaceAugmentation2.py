...
image_directory = 'C:/1-PC_M/1AI/ProjectOne/2ProjectOneGithub/DatasetRecognition/SubDataset/Tobias'  # Change to your folder path

# Call the function to augment images
augment_images_in_directory(image_directory)
